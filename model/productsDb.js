...
SELECT 
    ...
    pk.category, 
    NULL AS quantity, 
    GROUP_CONCAT(p.prodName SEPARATOR ', ') AS ingredients,  -- List of products in the package
...
const insertProductDb = async (
  ...
  let [data] = await pool.query(
    `INSERT INTO products (prodName, price, prodDesc, image, category, quantity, ingredients, usage_instructions) VALUES (?,?,?,?,?,?,?,?)`,
    [
      prodName,
      price,
      prodDesc,
